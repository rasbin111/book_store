...
import BookReview from "./components/Reviews";
        ...
        {data && (
          <div className="book-item-container">
              ...
              >
                ...
                {data.bookById.images.length > 0 &&
                  data.bookById.images
                    .filter(
                      (image) => image.id != data.bookById.primaryImage?.id,
                    )
              ...
              <div className="basic-info">
                ...
                <div className="basic-info-body">
                  <div className="book-rating">
                    <Rating
                      defaultValue={data.bookById.averageRating}
                      fractions={4}
                      readOnly
                    />
            ...
            <div className="book-details-box">
              <BookDetailsTabs book={data.bookById} />
              <BookReview />
            </div>
          </div>
        )}
